...
class KullanicisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create kullanici" do
    assert_difference('Kullanici.count') do
      post kullanicis_url, params: { kullanici: { ad: @kullanici.ad, calıstıgınız_is_yeri: @kullanici.calıstıgınız_is_yeri, email: @kullanici.email, okudugunuz_okul: @kullanici.okudugunuz_okul, soyad: @kullanici.soyad, telefon_numarası: @kullanici.telefon_numarası } }
    end
  ...
  test "should update kullanici" do
    patch kullanici_url(@kullanici), params: { kullanici: { ad: @kullanici.ad, calıstıgınız_is_yeri: @kullanici.calıstıgınız_is_yeri, email: @kullanici.email, okudugunuz_okul: @kullanici.okudugunuz_okul, soyad: @kullanici.soyad, telefon_numarası: @kullanici.telefon_numarası } }
